...
const HeroSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const SHEETS_URL = 'https://script.google.com/macros/s/AKfycbzKcdavjO6aB8GaWxdKt1qWh4R3HKs9jaxF4G-nsgNCjZ5M5KkDr-_2Ul_KoYNzTVjf/exec';
    ...
    supabase?.from('sheet_leads_37').insert({
      'Nome': trimmedName,
      'E-mail': trimmedEmail,
    ...
    setTimeout(() => {
      window.location.href = 'https://obrigado37.institutodespertamente.site/';
    }, 2000);
  };
